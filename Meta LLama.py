...
hf_token = "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"  # Replace with your actual token

# Model specifically trained for Q and A

# Model specifically trained for Q and A, with access token
model_name = "meta-llama/Llama-3.1-8B-Instruct"  # Use the correct model name
